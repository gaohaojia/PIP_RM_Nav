...
class pointcloud_filter : public rclcpp::Node
{
    public :
        ...
        {
            sub = this->create_subscription<sensor_msgs::msg::PointCloud2>("livox/lidar/pointcloud", 10, std::bind(&pointcloud_filter::sub_callback, this, std::placeholders::_1));
            pub = this->create_publisher<sensor_msgs::msg::PointCloud2>("/pointcloud_filtered",10);
        }
